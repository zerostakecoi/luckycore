...
pkgdatadir = $(datadir)/luckybitcore
pkgincludedir = $(includedir)/luckybitcore
pkglibdir = $(libdir)/luckybitcore
pkglibexecdir = $(libexecdir)/luckybitcore
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/config/luckybit-config.h.in \
...
CONFIG_HEADER = $(top_builddir)/src/config/luckybit-config.h
...
ACLOCAL = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/lucky/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/lucky/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/lucky/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/lucky/build-aux/missing automake-1.14
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/lucky/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = luckybitcore
PACKAGE_BUGREPORT = https://github.com/luckybitcoin/luckybit/issues
PACKAGE_NAME = LuckyBit Core
PACKAGE_STRING = LuckyBit Core 0.12.1
PACKAGE_TARNAME = luckybitcore
PACKAGE_URL = 
...
ZMQ_CFLAGS =  
ZMQ_LIBS = -lzmq  
abs_builddir = /home/ryseek/Desktop/Shared/Home/newCoin/lucky
abs_srcdir = /home/ryseek/Desktop/Shared/Home/newCoin/lucky
abs_top_builddir = /home/ryseek/Desktop/Shared/Home/newCoin/lucky
abs_top_srcdir = /home/ryseek/Desktop/Shared/Home/newCoin/lucky
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ryseek/Desktop/Shared/Home/newCoin/lucky/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/luckybitd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/luckybit-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/luckybit-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = LuckyBit-Qt.app
OSX_DMG = LuckyBit-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_luckybit_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_luckybit_coverage.info test_luckybit.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/LuckyBit-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/luckybit-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/luckybit-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/luckybit-config.h
$(top_srcdir)/src/config/luckybit-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/luckybit-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/LuckyBit-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/LuckyBit-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "LuckyBit-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/LuckyBit-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_luckybit.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_luckybit -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_luckybit_filtered.info: test_luckybit.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_luckybit_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_luckybit_filtered.info
...
#test_luckybit_coverage.info: baseline_filtered_combined.info test_luckybit_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_luckybit_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_luckybit_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_luckybit_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_luckybit.coverage/.dirstamp:  test_luckybit_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_luckybit.coverage/.dirstamp total.coverage/.dirstamp

# LuckyBit: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_luckybit.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
