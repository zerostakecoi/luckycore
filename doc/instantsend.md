...
* WebSocket: [https://github.com/luckybitcoin/insight-api-luckybit#web-socket-api](https://github.com/luckybitcoin/insight-api-luckybit#web-socket-api) 
* API: [https://github.com/luckybitcoin/insight-api-luckybit#instantsend-transactions](https://github.com/luckybitcoin/insight-api-luckybit#instantsend-transactions) 
...
By default, the LuckyBit Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LuckyBit Core daemon:
