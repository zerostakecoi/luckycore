...
git clone https://github.com/luckybitcoin/luckybit
```
...
in the LuckyBit Core repository under 'Fetch and build inputs' to install sources which require
...
```bash
    ...
    From https://github.com/luckybitcoin/luckybit
...
BTCPATH=/some/root/path/luckybit.git
SIGPATH=/some/root/path/luckybit-detached-sigs.git
...
[luckybit/gitian.sigs](https://github.com/luckybitcoin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
