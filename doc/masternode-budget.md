...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ LUCKY, _12_ times over the course of a year totaling _24000_ LUCKY.
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` LUCKY to ```y6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
