...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"luckybitaddress\"\n"
            "\nReveals the private key corresponding to 'luckybitaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"luckybitaddress\"   (string, required) The luckybit address for the private key\n"
            "\nResult:\n"
...
UniValue dumpwallet(const UniValue& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by LuckyBit Core %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
