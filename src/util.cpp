...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            if(ptrCategory->count(string("luckybit"))) {
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\LuckyBitCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\LuckyBitCore
    // Mac: ~/Library/Application Support/LuckyBitCore
    // Unix: ~/.luckybitcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "LuckyBitCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/LuckyBitCore";
#else
    // Unix
    return pathRet / ".luckybitcore";
#endif
#endif
}
