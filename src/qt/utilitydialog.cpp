    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("LuckyBit Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About LuckyBit Core"));
...
These denominations are 0.01 LUCKY, 0.1 LUCKY, 1 LUCKY and 10 LUCKY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://luckybitcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://luckybitcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("LuckyBit Core is shutting down...") + "<br /><br />" +
