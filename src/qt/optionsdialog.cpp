    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LUCKY-light"), QVariant("light"));
    ui->theme->addItem(QString("LUCKY-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LUCKY-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LUCKY-traditional"), QVariant("trad"));
