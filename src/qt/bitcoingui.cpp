    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("LuckyBit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About LuckyBit Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LuckyBit Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the LuckyBit Core help message to get a list with possible LuckyBit Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("LuckyBit Core client") + " " + networkStyle->getTitleAddText();
