/* src/config/luckybit-config.h.  Generated from luckybit-config.h.in by configure.  */
/* src/config/luckybit-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/luckybitcoin/luckybit/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LuckyBit Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LuckyBit Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "luckybitcore"
