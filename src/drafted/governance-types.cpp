...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LuckyBitNetwork") type = LuckyBitNetwork;
    if(strType == "LuckyBitNetworkVariable") type = LuckyBitNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LuckyBitNetwork) s = "LuckyBitNetwork";
    if(type == LuckyBitNetworkVariable) s = "LuckyBitNetworkVariable";
