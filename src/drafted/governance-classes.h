 ...
 *
 *   // network
 *   CLuckyBitNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.luckybit.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLuckyBitNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CLuckyBitNetwork(UniValue objIn)
    {
...
// // can be under: LuckyBitNetwork
// //   -- signature requirements : Key1(User)
// class CLuckyBitNetworkVariable : public CGovernanceObject
// {
// private:
