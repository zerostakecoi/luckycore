...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "luckybit|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"luckybitaddress\"\n"
            "\nReturn information about the given luckybit address.\n"
            "\nArguments:\n"
            "1. \"luckybitaddress\"     (string, required) The luckybit address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"luckybitaddress\", (string) The luckybit address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"luckybitaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"luckybitaddress\"  (string, required) The luckybit address to use for the signature.\n"
